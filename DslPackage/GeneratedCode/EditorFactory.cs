...
namespace edzzn.DB
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.DBEditorFactoryId)]
	internal partial class DBEditorFactory : DBEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new DBEditorFactory.
		/// </summary>
		public DBEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class DBEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected DBEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new DBDocData(this.ServiceProvider, typeof(DBEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new DBDocView(docData, this.ServiceProvider);
		}
	}
}
