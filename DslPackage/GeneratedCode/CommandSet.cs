...
namespace edzzn.DB
{
	...
	/// </summary>
	internal partial class DBCommandSet : DBCommandSetBase
	{
		/// <summary>
		/// Constructs a new DBCommandSet.
		/// </summary>
		public DBCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class DBCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new DBCommandSetBase.
		/// </summary>
		protected DBCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewDBExplorerCommand,
				typeof(DBEditorFactory).GUID);
		...
		{
			DBExplorerToolWindow explorer = this.DBExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected DBDocData CurrentDBDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as DBDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected DBDocView CurrentDBDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as DBDocView;
			}
		}
		...
		/// </summary>
		protected DBExplorerToolWindow DBExplorerToolWindow
		{
			get
			{
				DBExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(DBExplorerToolWindow), true) as DBExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				DBExplorerToolWindow explorerWindow = this.DBExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class DBClipboardCommandSet : DBClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new DBClipboardCommandSet.
		/// </summary>
		public DBClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class DBClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new DBClipboardCommandSetBase.
		/// </summary>
		protected DBClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
