...
namespace edzzn.DB
{
	...
	/// </summary>
	internal partial class DBDocView : DBDocViewBase
	{
		/// <summary>
		/// Constructs a new DBDocView.
		/// </summary>
		public DBDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class DBDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new DBDocView.
		/// </summary>
		protected DBDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			DBDocDataBase docData = this.DocData as DBDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for DBDocViewBase should be an DBDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::edzzn.DB.DBDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::edzzn.DB.DBDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::edzzn.DB.DBToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::edzzn.DB.DBToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.DBDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::edzzn.DB.DBHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::edzzn.DB.DBHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::edzzn.DB.DBHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
