...
namespace edzzn.DB
{
	...
	/// </summary>
	internal partial class DBExplorer : DBExplorerBase
	{
		/// <summary>
		/// Constructs a new DBExplorer.
		/// </summary>
		public DBExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the DBExplorerToolWindow.
	/// </summary>
	internal abstract class DBExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new DBExplorerBase.
		/// </summary>
		protected DBExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.DBExplorerMenu;
			}
		}
		...
		{
			get { return global::edzzn.DB.DBModel.DomainClassId; }
		}
