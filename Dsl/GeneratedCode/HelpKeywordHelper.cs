...
namespace edzzn.DB
{
	...
	/// </remarks>
	public partial class DBHelpKeywordHelper : DBHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new DBHelpKeywordHelper.
		/// </summary>
		protected DBHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the DBHelpKeywordHelper.
		/// </summary>
		public static DBHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class DBHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new DBHelpKeywordHelperBase.
		/// </summary>
		protected DBHelpKeywordHelperBase()
			: base() { }
